...
class Session(models.Model):
    ...
    # Estado atual
    current_round_number = models.IntegerField(default=0) # 0 = lobby, 1 = round 1...
...
class Round(models.Model):
    session = models.ForeignKey(Session, related_name='rounds', on_delete=models.CASCADE)
    location = models.ForeignKey(Location, related_name='used_in_rounds', on_delete=models.CASCADE)
    ...
    class Meta:
        ...
        ordering = ['round_number'] # Garante que venha na ordem certa (1, 2, 3...)
